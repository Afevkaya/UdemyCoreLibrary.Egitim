...
namespace FluentValidationApp.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            // IValidator interface üzerinden gelen validate metodunun kullanımı.
            // Validate metodu classların geçerli olup olmadığını kontrol eder.
            // ModelState de aynı işleve sahiptir.
            var validatonResult = _customerValidator.Validate(customer);
